public class Menu {
  //August & Jens
    private final String[] MANAGE_MEMBER_MENU = {"1. Add new member", "2. View member list ", "3. Delete a member",
  ...
  private final String[] TOP_5_MENU = {"1. Top 5 Breast Swim - Junior","2. Top 5 Crawl - Junior",
  ...
  private final String[] CASHIER_MENU = {"1. Display MembershipPayment total","2. Display Total Payment",
